// Canonical Cloudinary Visual Experience Layer.
// IMPORTANT: This registry is intentionally separate from the 270 ImageKit
// product DAM assets and the 38 Paystack product catalog.
//
// Cloudinary public IDs are canonical. Upload/build tooling should populate
// these exact IDs; the application must not substitute ImageKit product media.
...
/**
 * Delivery helper. Set VITE_CLOUDINARY_CLOUD_NAME in the deployment
 * environment; never hard-code credentials or API secrets in this module.
 */
